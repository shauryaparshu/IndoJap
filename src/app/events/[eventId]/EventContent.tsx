...
const EventContent: FC<{ event: { postContent: string } }> = ({ event }) => {
  ...
  <div
    ...
    className="prose lg:prose-lg !max-w-screen-md mx-auto dark:prose-invert break-words"
    ref={contentRef}
    dangerouslySetInnerHTML={{ __html: event.postContent }}
  ></div>
</div>
      ...
      <div
        className={`sticky mt-8 bottom-8 z-40 flex justify-center ${
